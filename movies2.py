...
movie_titles = ["Star Wars Episode I", "Star Wars Episode II", "Star Wars Epiosode III", "Star War Epiosode IV", "Star Wars Episode V"]
ratings = ["PG", "PG", "PG", "PG", "PG"]
bechdel_ratings = [1, 3, 3, 1, 0]
imdb_ratings = [6.5, 6.8, 7.7, 8.8]
genres = ["action/adventure/fantasy", "action/adventure/fantasy", "action/adventure/fantasy", "action/adventure/fantasy", "action/adventure/fantasy"]

for movie_title, rating, bechdel_rating, imdb_rating, genre in zip(movie_titles, ratings, bechdel_ratings, imdb_ratings, genres):
	print "{0}, {1}, {2}, {3}, {4}".format(movie_title, rating, bechdel_rating, imdb_rating, genre)
